    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preventa', models.ForeignKey(db_column=b'/BIC/ZCLPRVTA', to='maestros.AtributoInterlocutor', null=True)),
                ('supervisor', models.ForeignKey(db_column=b'/BIC/ZCLSUPER', to='maestros.AtributoInterlocutor', null=True)),
            ],
            options={
